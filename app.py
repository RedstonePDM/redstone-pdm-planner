...
<div class="layout">
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-search">
      <input type="text" id="search-input" placeholder="Search by site, job number, trade..." oninput="filterJobs()">
    </div>
